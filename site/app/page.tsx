...
const ladder = [
  ...
  ["05", "You explain it back", "Before anything gets confirmed, you walk Journeyman through how it works and what it'll do."],
] as const;
  ...
  return (
    <SiteShell current="home">
      <section className="hero section-dark" aria-labelledby="hero-title">
        <div className="shell hero-grid">
          <div className="hero-copy">
            <p className="eyebrow">01 · Meet Hoolio, the Little AI Company owl</p>
            <h1 id="hero-title">The AI that <em className="serif-pop">won’t</em> do your homework.</h1>
            <p className="hero-lede">Pick the job you want. Journeyman reads the actual job ads, finds what you are missing, and hands you real work to close the gap. It helps when you are stuck. It just will not do it for you. That is the whole point.</p>
          ...
          <div className="hero-stage">
            <div className="chat-window" aria-label="A cold ask, the refusal, then a real attempt and its earned hint">
              <div className="chat-head"><span className="status-dot" />Journeyman · a real learner session</div>
              ...
              {featuredHint ? <div className="chat-message mentor hint"><span>Journeyman · hint {featuredHint.level}/5 · earned</span><p>{featuredHint.content}</p></div> : null}
            </div>
      ...
      <section className="receipts section-dark" id="receipts" aria-labelledby="receipts-title">
        ...
        <div className="shell">
          <div className="section-heading with-owl"><div><p className="eyebrow">03 · The receipts</p><h2 id="receipts-title">Your plan comes from real job ads.</h2><p>Paste in postings for jobs you actually want. Journeyman reads them and lists what you are missing, and every gap points back at the exact line in the ad that asked for it. {snapshot.gapAnalysis?.summary ? "Here’s the demo learner’s real list:" : "No saved gap list to show yet."}</p></div><Owl pose="checking" alt="Hoolio reading a job posting with a loupe" /></div>
      ...
      <section className="ladder section-slate" aria-labelledby="ladder-title">
        ...
        <div className="shell split-section ladder-layout">
          <div><p className="eyebrow">04 · The struggle ladder</p><h2 id="ladder-title">Show your work, earn your help.</h2><p className="section-lede">Send Journeyman something real: code, a broken draft, an error message, a link. That earns one step of help. Ask cold and you get a polite no. Five steps, and the last one is you doing the explaining.</p>
      ...
      <section className="try-it section-cream" aria-labelledby="try-title">
        ...
        <div className="action-grid">
          ...
          <article><span className="card-number">02</span><h3>Read the real conversation</h3><p>Every saved attempt and earned hint, exactly as the learner and Journeyman exchanged them.</p><a href={withBase(`/t/${transcriptSlug}/`)}>Open transcript →</a></article>
